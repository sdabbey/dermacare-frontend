...
import signupbg1 from '../../assets/signupbg1.jpg';
      ...
      >
        ...
        >
          ...
          >
            ...
            <ColorSchemeToggle sx={{height: 'fit-content', my: '1rem'}}  />
          </Box>
          {/* Main */}
          <Box
            component="main"
          ...
          >
            ...
            <Stack gap={4} sx={{ height: '20%'}}>
              <Stack gap={1}>
                <Typography component="h1" level="h3" sx={{textAlign: 'center'}}>
                  Join us <span style={{color: 'var(--sx-color-primary)'}}>today</span> - Your Health, Simplified
                </Typography>
                <Typography component="p" level="body-sm" sx={{textAlign: 'center'}}>Create an account to book appointments, access virtual consultations, and manage your healthcare in one place.</Typography>
          ...
          {/* Footer */}
          <Box component="footer" sx={{background: 'transparent', height: '5%', py: 3 }}>
