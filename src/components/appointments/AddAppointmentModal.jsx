...
export default function AddAppointmentModal({
  ...
  React.useEffect(() => {
    ...
    // Fetch treatments
    axios.get('https://dermacare-group.up.railway.app/clinic/treatments')
        .then(response => {
  ...
  const handleFormSubmit = async () => {
    ...
    try {
        const response = await axios.post('https://dermacare-group.up.railway.app/clinic/appointments/add/', appointmentData);
